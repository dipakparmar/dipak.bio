...
export default function Home() {
  return (
    <div className="flex overflow-x-hidden relative flex-col p-0 m-0 w-full h-full min-h-screen font-bold leading-4 text-black align-baseline border-0">
      <Head>
        <meta charSet="UTF-8" />
        <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="☁️ DevOps Engineer" />
        <meta property="og:title" content="Dipak Parmar | DevSecOps Engineer" />
        <meta property="og:description" content="☁️ DevSecOps Engineer" />
        <meta property="og:url" content="https://dipak.bio/links" />
        <meta property="og:image:height" content="600" />
        <meta property="og:image:type" content="image/jpg" />
        <meta property="og:image:width" content="600" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:site_name" content="DipakBio" />
        <meta property="og:type" content="profile" />
        {/* <meta content="2419200" /> */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:domain" content="DipakParmar" />
        <meta name="theme-color" content="#ffffff" />
        <meta property="og:image" content="https://github.com/dipakparmar.png" />
        <meta
          property="og:image:secure_url"
          content="https://github.com/dipakparmar.png"
        />
        <meta property="og:updated_time" content="1650069578000" />
        <meta property="profile:username" content="iamdipakparmar" />
        <meta
          name="twitter:title"
          content="@iamdipakparmar | Dipak Parmar | ☁️ DevSecOps Engineer"
        />
        <meta name="twitter:description" content="☁️ DevSecOps Engineer" />
        <meta name="twitter:image" content="https://github.com/dipakparmar.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <link rel="canonical" href="https://dipak.bio/links" />
        ...
        <link
          rel="icon"
          type="image/png"
          href="https://github.com/dipakparmar.png"
        />
        <link
          rel="icon"
          type="image/png"
          href="https://github.com/dipakparmar.png?size=96"
          sizes="96x96"
        />
        <link
          rel="icon"
          type="image/png"
          href="https://github.com/dipakparmar.png?size=32"
          sizes="32x32"
        />
        <link
          rel="icon"
          type="image/png"
          href="https://github.com/dipakparmar.png?size=16"
          sizes="16x16"
        />
        <link
          rel="apple-touch-icon"
          sizes="180x180"
          href="https://github.com/dipakparmar.png?size=180"
        />
        <link
          rel="apple-touch-icon"
          sizes="152x152"
          href="https://github.com/dipakparmar.png?size=152"
        />
        <link
          rel="apple-touch-icon"
          sizes="144x144"
          href="https://github.com/dipakparmar.png?size=144"
        />
        <link
          rel="apple-touch-icon"
          sizes="120x120"
          href="https://github.com/dipakparmar.png?size=12n0"
        />
        <link
          rel="apple-touch-icon"
          sizes="114x114"
          href="https://github.com/dipakparmar.png?size=114"
        />
        <link
          rel="apple-touch-icon"
          sizes="72x72"
          href="https://github.com/dipakparmar.png?size=72"
        />
        <link
          rel="apple-touch-icon"
          sizes="76x76"
          href="https://github.com/dipakparmar.png?size=76"
        />
        <link
          rel="apple-touch-icon"
          sizes="60x60"
          href="https://github.com/dipakparmar.png?size=60"
        />
        <link
          rel="apple-touch-icon"
          sizes="57x57"
          href="https://github.com/dipakparmar.png?size=57"
        />
        <meta
          name="msapplication-square310x310logo"
          content="https://github.com/dipakparmar.png?size=310"
        />
        <meta
          name="msapplication-square150x150logo"
          content="https://github.com/dipakparmar.png?size=150"
        />
        <meta
          name="msapplication-square70x70logo"
          content="https://github.com/dipakparmar.png?size=70"
        />
        <meta
          name="msapplication-TileImage"
          content="https://github.com/dipakparmar.png?size=144"
        />
        <meta name="msapplication-TileColor" content="#FFFFFF" />
        <meta name="theme-color" content="#ffffff" />
        <title>@iamdipakparmar | Dipak Parmar | ☁️ DevSecOps Engineer</title>
        <meta name="next-head-count" content="10" />
      </Head>
      <main className="flex flex-col flex-1 justify-between py-6 px-3 m-0 w-full h-full leading-4 align-baseline border-0">
        <div className="px-0 pt-0 pb-20 my-0 mx-auto w-full h-full text-black align-baseline border-0" style={{ maxWidth: '680px' }}>
          ...
          <div className="p-0 mx-0 mt-0 mb-4 align-baseline border-0">
            <div className="flex flex-col items-center p-0 mx-0 mt-3 mb-8 w-full h-full align-baseline border-0">
              ...
              <div className="py-0 px-10 m-0 align-baseline border-0">
                <h2 className="p-0 m-0 text-sm leading-normal text-center align-baseline border-0">
                  ☁️ DevOps Engineer
                </h2>
              </div>
            </div>
          </div><div className="relative p-0 m-0 align-baseline border-0">
            <div data-testid="StyledContainer" className="overflow-hidden relative z-0 p-0 mx-0 mt-0 mb-4 h-auto text-white align-baseline bg-blue-500 rounded-none border-2 border-blue-500 border-solid hover:border-blue-500 hover:bg-transparent hover:text-blue-500" style={{ "WebkitTransition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s", "transition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s" }}>
              <a href="https://transit.dipak.io/playground" target="_blank" rel="noopener" data-testid="LinkButton" aria-describedby="profile-iamdipakparmar " height="auto" className="flex relative justify-center items-center py-4 px-5 m-0 w-full h-auto text-center align-middle whitespace-normal break-words bg-none appearance-none cursor-pointer box-border" style={{ "WebkitTextDecoration": "none", "textDecoration": "none", "wordBreak": "break-word", "WebkitHyphens": "auto", "MozHyphens": "auto", "msHyphens": "auto", "hyphens": "auto", "WebkitTransition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s", "transition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s" }}>
                <p className="relative p-0 m-0 w-full leading-normal align-baseline border-0" style={{ "WebkitHyphens": "none", "MozHyphens": "none", "msHyphens": "none", "hyphens": "none", "wordBreak": "break-word" }}>
                  ☸️ GraphQL API for BC Transit
                </p>
              </a>
            </div>
          </div>
          <div className="relative p-0 m-0 align-baseline border-0">
            <div data-testid="StyledContainer" className="overflow-hidden relative z-0 p-0 mx-0 mt-0 mb-4 h-auto text-white align-baseline bg-blue-500 rounded-none border-2 border-blue-500 border-solid hover:border-blue-500 hover:bg-transparent hover:text-blue-500" style={{ "WebkitTransition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s", "transition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s" }}>
              <a href="https://www.linkedin.com/in/iamdipakparmar/" target="_blank" rel="noopener" data-testid="LinkButton" aria-describedby="profile-iamdipakparmar " height="auto" className="flex relative justify-center items-center py-4 px-5 m-0 w-full h-auto text-center align-middle whitespace-normal break-words bg-none appearance-none cursor-pointer box-border" style={{ "WebkitTextDecoration": "none", "textDecoration": "none", "wordBreak": "break-word", "WebkitHyphens": "auto", "MozHyphens": "auto", "msHyphens": "auto", "hyphens": "auto", "WebkitTransition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s", "transition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s" }}>
                <p className="relative p-0 m-0 w-full leading-normal align-baseline border-0" style={{ "WebkitHyphens": "none", "MozHyphens": "none", "msHyphens": "none", "hyphens": "none", "wordBreak": "break-word" }}>
                  Connect with Me
                </p>
              </a>
          ...
          <div className="relative p-0 m-0 align-baseline border-0">
            <div data-testid="StyledContainer" className="overflow-hidden relative z-0 p-0 mx-0 mt-0 mb-4 h-auto text-white align-baseline bg-blue-500 rounded-none border-2 border-blue-500 border-solid hover:border-blue-500 hover:bg-transparent hover:text-blue-500" style={{ "WebkitTransition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s", "transition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s" }}>
              <a href="https://about.me/dipakparmar" target="_blank" rel="noopener" data-testid="LinkButton" aria-describedby="profile-iamdipakparmar " height="auto" className="flex relative justify-center items-center py-4 px-5 m-0 w-full h-auto text-center align-middle whitespace-normal break-words bg-none appearance-none cursor-pointer box-border" style={{ "WebkitTextDecoration": "none", "textDecoration": "none", "wordBreak": "break-word", "WebkitHyphens": "auto", "MozHyphens": "auto", "msHyphens": "auto", "hyphens": "auto", "WebkitTransition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s", "transition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s" }}>
                <p className="relative p-0 m-0 w-full leading-normal align-baseline border-0" style={{ "WebkitHyphens": "none", "MozHyphens": "none", "msHyphens": "none", "hyphens": "none", "wordBreak": "break-word" }}>
                  About Me
                </p>
              </a>
          ...
          <div className="relative p-0 m-0 align-baseline border-0">
            <div data-testid="StyledContainer" className="overflow-hidden relative z-0 p-0 mx-0 mt-0 mb-4 h-auto text-white align-baseline bg-blue-500 rounded-none border-2 border-blue-500 border-solid hover:border-blue-500 hover:bg-transparent hover:text-blue-500" style={{ "WebkitTransition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s", "transition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s" }}>
              <a href="https://github.com/dipakparmar" target="_blank" rel="noopener" data-testid="LinkButton" aria-describedby="profile-iamdipakparmar " height="auto" className="flex relative justify-center items-center py-4 px-5 m-0 w-full h-auto text-center align-middle whitespace-normal break-words bg-none appearance-none cursor-pointer box-border" style={{ "WebkitTextDecoration": "none", "textDecoration": "none", "wordBreak": "break-word", "WebkitHyphens": "auto", "MozHyphens": "auto", "msHyphens": "auto", "hyphens": "auto", "WebkitTransition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s", "transition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s" }}>
                <p className="relative p-0 m-0 w-full leading-normal align-baseline border-0" style={{ "WebkitHyphens": "none", "MozHyphens": "none", "msHyphens": "none", "hyphens": "none", "wordBreak": "break-word" }}>
                  Projects
                </p>
              </a>
          ...
          <div className="px-0 pt-6 pb-4 m-0 align-baseline border-0">
            <h3 id="header-85387280" className="p-0 m-0 text-base leading-normal text-center align-baseline border-0">
              News/Blog
            </h3>
          </div>
          <div className="relative p-0 m-0 align-baseline border-0">
            <div data-testid="StyledContainer" className="overflow-hidden relative z-0 p-0 mx-0 mt-0 mb-4 h-auto text-white align-baseline bg-blue-500 rounded-none border-2 border-blue-500 border-solid hover:border-blue-500 hover:bg-transparent hover:text-blue-500" style={{ "WebkitTransition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s", "transition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s" }}>
              <a href="https://infotel.ca/newsitem/kamloops-business-students-create-solution-for-online-sales/it67119" target="_blank" rel="noopener" data-testid="LinkButton" aria-describedby="profile-iamdipakparmar header-85387280" height="auto" className="flex relative justify-center items-center py-4 px-5 m-0 w-full h-auto text-center align-middle whitespace-normal break-words bg-none appearance-none cursor-pointer box-border" style={{ "WebkitTextDecoration": "none", "textDecoration": "none", "wordBreak": "break-word", "WebkitHyphens": "auto", "MozHyphens": "auto", "msHyphens": "auto", "hyphens": "auto", "WebkitTransition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s", "transition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s" }}>
                <p className="relative p-0 m-0 w-full leading-normal align-baseline border-0" style={{ "WebkitHyphens": "none", "MozHyphens": "none", "msHyphens": "none", "hyphens": "none", "wordBreak": "break-word" }}>
                  InfoTel news: CarGo Marketplace
                </p>
              </a>
            </div>
          </div>
          <div className="relative p-0 m-0 align-baseline border-0">
            <div data-testid="StyledContainer" className="overflow-hidden relative z-0 p-0 mx-0 mt-0 mb-4 h-auto text-white align-baseline bg-blue-500 rounded-none border-2 border-blue-500 border-solid hover:border-blue-500 hover:bg-transparent hover:text-blue-500" style={{ "WebkitTransition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s", "transition": "box-shadow 0.25s                    cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                  background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s" }}>
              <a href="http://bit.ly/2IPrtlJ" target="_blank" rel="noopener" data-testid="LinkButton" aria-describedby="profile-iamdipakparmar header-85387280" height="auto" className="flex relative justify-center items-center py-4 px-5 m-0 w-full h-auto text-center align-middle whitespace-normal break-words bg-none appearance-none cursor-pointer box-border" style={{ "WebkitTextDecoration": "none", "textDecoration": "none", "wordBreak": "break-word", "WebkitHyphens": "auto", "MozHyphens": "auto", "msHyphens": "auto", "hyphens": "auto", "WebkitTransition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s", "transition": "box-shadow 0.25s                      cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    border-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    transform 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99) 0s,                    background-color 0.25s cubic-bezier(0.08, 0.59, 0.29, 0.99)                      0s" }}>
                <p className="relative p-0 m-0 w-full leading-normal align-baseline border-0" style={{ "WebkitHyphens": "none", "MozHyphens": "none", "msHyphens": "none", "hyphens": "none", "wordBreak": "break-word" }}>
                  5 Premium Resources You Get as a TRU Student
                </p>
              </a>
            </div>
          </div>
          <div className="py-4 px-0 m-0 align-baseline border-0">
            <div className="flex flex-wrap justify-center items-center p-0 m-0 w-full h-full align-baseline border-0" data-windy-selected="loU0ygnmDxzpazytHVEGS">
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://facebook.com/Iamdipakparmar" aria-label="@iamdipakparmar facebook" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
              ...
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://twitter.com/iamdipakparmar" aria-label="@iamdipakparmar twitter" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-8 h-8 pointer-events-none" style={{}}>
              ...
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://instagram.com/iamdipakparmar" aria-label="@iamdipakparmar instagram" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-8 h-8 pointer-events-none" style={{}}>
              ...
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://tiktok.com/@iamdipakparmar" aria-label="@iamdipakparmar tiktok" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-8 h-8 pointer-events-none" style={{}}>
              ...
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://twitch.tv/iamdipak" aria-label="@iamdipakparmar twitch" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-8 h-8 pointer-events-none" style={{}}>
              ...
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="mailto:hello@dipak.tech" aria-label="@iamdipakparmar email_address" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-8 h-8 pointer-events-none" style={{}}>
              ...
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://joinclubhouse.com/@iamdipakparmar" aria-label="@iamdipakparmar clubhouse" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-8 h-8 pointer-events-none" style={{}}>
              ...
              <a target="_blank" rel="noopener" data-testid="SocialIcon" href="https://t.me/Dipakparmar65" aria-label="@iamdipakparmar telegram" className="z-0 px-2 pt-0 pb-3 m-0 align-baseline border-0 cursor-pointer" style={{ "WebkitTextDecoration": "underline", "textDecoration": "underline", "WebkitTransition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s", "transition": "transform 0s cubic-bezier(0.23, 1, 0.32, 1) 0s" }}>
                <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-8 h-8 pointer-events-none" style={{}}>
